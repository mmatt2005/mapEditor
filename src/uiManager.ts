import { GameMapOptions, type Edge, type Node, type Prop, type Zone } from "./types"

export class UIManager { 
    private currentMap: keyof (typeof GameMapOptions) = "CITY"
    private sideMenu: Readonly<{activeMenu: "debug" | "node" | "edge" | "zone" | "prop" | null, menuData: Node | Edge | Zone | Prop | null}> = {activeMenu: null, menuData: null} 
